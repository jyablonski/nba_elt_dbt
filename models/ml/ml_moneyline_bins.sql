...
-- dividing by 10 here to get the metrics in teams of for every 1 dollar bet (bc the source table has it set at $10 a bet)
bet_aggs as (
    select 
    ...
    from bets
    where (moneyline_parameter_lower::numeric NOT BETWEEN 0 AND 95)
