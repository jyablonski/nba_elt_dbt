...
final as (
    select
        ...
        player_rolling_avg.rolling_avg_pts - int_player_stats.avg_ppg as ppg_diff,
        player_rolling_avg.rolling_avg_ts_percent - int_player_stats.avg_ts_percent as ts_percent_diff,
        player_rolling_avg.rolling_avg_mvp_score - int_player_stats.avg_mvp_score as mvp_score_diff,
        player_rolling_avg.rolling_avg_plus_minus - int_player_stats.avg_plus_minus as plus_minus_diff,
        max_player_game_date.max_game_date
    from player_rolling_avg
        inner join {{ ref('int_player_stats') }} on player_rolling_avg.player = int_player_stats.player
