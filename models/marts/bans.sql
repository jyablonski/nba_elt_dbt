...
final3 as (
    select
        *,
        case
            when sum_active_protocols > sum_active_protocols_lastwk then concat(protocols_differential, ' More Cases (', round(protocols_pct_diff, 1), '% Increase) from 7 days ago')
